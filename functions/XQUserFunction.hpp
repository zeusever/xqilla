...
class XQILLA_CLASS XQUserFunctionInstance : public XQFunction, public ExternalFunction::Arguments
{
public:
...
class XQILLA_CLASS XQUserFunction : public FuncFactory, public LocationInfo
{
public:
  class XQILLA_CLASS Mode : public LocationInfo
  {
  public:
    enum State {
      QNAME,
...
class XQILLA_CLASS DelayedFuncFactory : public FuncFactory
{
public:
