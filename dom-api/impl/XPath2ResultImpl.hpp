...
class XQILLA_CLASS XPath2ResultImpl : public
...
class XQILLA_CLASS XPath2FirstResultImpl : public XPath2ResultImpl
{
public:
...
class XQILLA_CLASS XPath2SnapshotResultImpl : public XPath2ResultImpl
{
public:
...
class XQILLA_CLASS XPath2IteratorResultImpl : public XPath2ResultImpl
{
public:
