...
class XQILLA_CLASS XQNav : public ASTNodeImpl
{
public:
  class XQILLA_CLASS StepInfo {
  public:
    StepInfo() : step(0) {}
...
class XQILLA_CLASS NavStepResult : public ResultImpl
{
public:
...
class XQILLA_CLASS IntermediateStepCheckResult : public ResultImpl
{
public:
...
class XQILLA_CLASS LastStepCheckResult : public ResultImpl
{
public:
