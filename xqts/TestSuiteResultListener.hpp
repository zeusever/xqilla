...
class XQILLA_CLASS TestSuiteResultListener
{
public:
...
class XQILLA_CLASS KnownErrorChecker : public TestSuiteResultListener
{
public:
...
class XQILLA_CLASS ConsoleResultListener : public TestSuiteResultListener
{
public:
...
class XQILLA_CLASS XMLReportResultListener : public TestSuiteResultListener
{
public:
