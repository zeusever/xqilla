...
class XQILLA_CLASS BaseInteractiveDebugger
{
public:
  struct XQILLA_CLASS Run {};
  struct XQILLA_CLASS Continue {};
  struct XQILLA_CLASS Quit {};
...
class XQILLA_CLASS DebugCommand
{
public:
...
class XQILLA_CLASS InteractiveDebugger :  private BaseInteractiveDebugger,
