...
class XQILLA_CLASS AutoNodeSetOrderingReset
{
public:
...
class XQILLA_CLASS AutoContextItemTypeReset
{
public:
...
class XQILLA_CLASS AutoNsScopeReset
{
public:
...
class XQILLA_CLASS AutoContextInfoReset
{
public:
...
class XQILLA_CLASS AutoDocumentCacheReset
{
public:
...
class XQILLA_CLASS AutoVariableStoreReset
{
public:
...
class XQILLA_CLASS AutoRegexGroupStoreReset
{
public:
...
class XQILLA_CLASS AutoMessageListenerReset
{
public:
...
class XQILLA_CLASS AutoStackFrameReset
{
public:
...
template<typename T> class XQILLA_CLASS AutoReset
{
public:
  AutoReset(T &orig)
    : orig_(orig)
