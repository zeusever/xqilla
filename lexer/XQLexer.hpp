...
class XQILLA_CLASS XQLexer : public Lexer, public yyFlexLexer
{
public:
  enum StartMode {
    MODE_NORMAL,
...
class XQILLA_CLASS XQParserArgs
{
public:
...
namespace XQParser {
  XQILLA_API int yyparse(void *);
  XQILLA_API int yydebug;
}
